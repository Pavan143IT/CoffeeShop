    ...
    return (
        <div id='contact' style={bgImage} className='min-h-screen flex items-center justify-center p-6'>
            <motion.div
                ...
                <p className='text-center text-lg text-gray-600 mb-8 font-cursive'>We’d love to connect with you! Fill out the form, and we’ll be in touch shortly.</p>
                ...
                <div className='mt-8 text-center'>
                    ...
                    <p className='font-semibold text-black'>+91- 9848022338</p>
                    <p className='font-semibold text-black'>info@pavancoffeewebsite.com</p>
                </div>
            </motion.div>
        </div>
    )
