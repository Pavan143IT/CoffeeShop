...
const MenuData = [
    {
      ...
      name: "HYD Niloufer",
      description:
        "Café Niloufer is one of Hyderabad’s most iconic tea cafés, famous for its strong, flavorful Irani chai and freshly baked Osmania biscuits.",
      price: 120
    },
    {
      id: 2,
      ...
      name: "Araku Coffee",
      description:
        "Araku Coffee is a premium coffee brand from the Araku Valley in India, known for its rich flavor and aroma.",
      price: 150
    },
    {
      id: 3,
      ...
      name: "Cold Coffee",
      description:
        "A refreshing blend of rich, aromatic coffee and chilled milk, whipped to creamy perfection and served over ice.",
      price: 100
    },
];
